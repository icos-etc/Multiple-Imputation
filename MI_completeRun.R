...
## R script to perform multiple imputation for 10 FLUXNET2015 datasets as described in Vitale, Bilancia, Papale (2018) A Multiple Imputation Strategy for Eddy Covariance Data

source("MIEC_complete.R")
...
## site: character string for the site ID as in the FLUXNET database, e.g. IT-CA1
